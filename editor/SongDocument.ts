...
export class SongDocument {
	...
	// Random Generation Setup
		...
		public harmonicsOnRandomization: boolean = true;
		...
		public panDelayOnRandomization: boolean = false;
		public fadeOnRandomization: boolean = true;
		public unisonOnRandomization: boolean = true;

		public EQFilterOnRandomization: boolean = true;
    	...
    	public supersawDynamismOnRandomization: boolean = true;
    	public supersawSpreadOnRandomization: boolean = true;
    	public supersawShapeOnRandomization: boolean = true;
