...
export class Localization {
    ...
    public static midboxFMPresetsLabel: string = "Midbox FM Presets"; // needs translation
    public static midboxWavetablePresetsLabel: string = "Midbox Wavetable Presets"; // needs translation
    public static midboxSFXPresetsLabel: string = "Midbox SFX Presets"; // needs translation
    public static midboxBassPresetsLabel: string = "Midbox Bass Presets"; // needs translation
    public static midboxSynthPresetsLabel: string = "Midbox Synth Presets"; // needs translation
    ...
    public static midboxMiscPresets4Label: string = "depths";
    public static midboxMiscPresets5Label: string = "sawtooth pluck";
    public static midboxMiscPresets6Label: string = "distorted guitar 1";
    public static midboxMiscPresets7Label: string = "distorted guitar 2";
    public static midboxMiscPresets8Label: string = "distorted guitar 3";
    public static midboxMiscPresets9Label: string = "jingle bells";
    public static midboxMiscPresets10Label: string = "countdown pulse";
    public static midboxMiscPresets11Label: string = "ambient pulse 1";
    public static midboxMiscPresets12Label: string = "ambient pulse 2";
    public static midboxMiscPresets13Label: string = "mechanical blip";
    public static midboxMiscPresets14Label: string = "guitar pluck";
    public static midboxMiscPresets15Label: string = "error";
    public static midboxMiscPresets16Label: string = "clang synth guitar";
    public static midboxMiscPresets17Label: string = "midbox banjo 1";
    public static midboxMiscPresets18Label: string = "corrupted vocals 1";
    public static midboxMiscPresets19Label: string = "sine synth pluck";
    public static midboxMiscPresets20Label: string = "electronic pluck 1";
    public static midboxMiscPresets21Label: string = "freq-crushed xylophone";
    public static midboxMiscPresets22Label: string = "electric guitar";
    public static midboxMiscPresets23Label: string = "electronic pluck 2";
    public static midboxMiscPresets24Label: string = "supersaw dist. guitar";
    public static midboxMiscPresets25Label: string = "corrupted vocals 2";
    public static midboxMiscPresets26Label: string = "lobby marimba";
    public static midboxMiscPresets27Label: string = "electronic pluck 3";
    public static midboxMiscPresets28Label: string = "dirty distortion guitar";
    public static midboxMiscPresets29Label: string = "midbox banjo 2";
    public static midboxMiscPresets30Label: string = "rave flute";
    public static midboxMiscPresets31Label: string = "phantom choir";
    public static midboxMiscPresets32Label: string = "FM wubber";
    public static midboxMiscPresets33Label: string = "bitcrushian guitar";
    public static midboxMiscPresets34Label: string = "intense sitar";
    ...
    public static midboxDubstepPresets25Label: string = "dubstep roar (morph)";
    public static midboxDubstepPresets26Label: string = "creak saw";
    public static midboxDubstepPresets27Label: string = "heavily crushed vocals";
    public static midboxDubstepPresets28Label: string = "eclipse";
    public static midboxDubstepPresets29Label: string = "disruptive growl";
    public static midboxDubstepPresets30Label: string = "system failure";
    public static midboxDubstepPresets31Label: string = "noise growl";
    ...
    public static midboxNoisePresets3Label: string = "extreme noise";
    ...
    public static midboxDrumPresets18Label: string = "slippery hi-hat";
    ...
    public static midboxLeadPresets4Label: string = "echo pulse lead 1";
    public static midboxLeadPresets5Label: string = "random lead";
    public static midboxLeadPresets6Label: string = "retro ghostly lead";
    public static midboxLeadPresets7Label: string = "industrial lead";
    public static midboxLeadPresets8Label: string = "chaotic pulse";
    public static midboxLeadPresets9Label: string = "squealing lead";
    public static midboxLeadPresets10Label: string = "distorted lead 2";
    public static midboxLeadPresets11Label: string = "random lead distortion";
    public static midboxLeadPresets12Label: string = "harmonized chipwave";
    public static midboxLeadPresets13Label: string = "freq-crushed sawtooth lead";
    public static midboxLeadPresets14Label: string = "retro pulse";
    public static midboxLeadPresets15Label: string = "square wave harp";
    public static midboxLeadPresets16Label: string = "echo pulse lead 2";
    public static midboxLeadPresets17Label: string = "casino lead";
    public static midboxLeadPresets18Label: string = "chip pluck";
    ...
    public static midboxSFXPresets1Label: string = "scream";
    public static midboxSFXPresets2Label: string = "terminal blip";
    public static midboxSFXPresets3Label: string = "doom triangle";
    public static midboxSFXPresets4Label: string = "siren";
    public static midboxSFXPresets5Label: string = "cicada buzz";
    public static midboxSFXPresets6Label: string = "telephone ring 2";
    public static midboxBassPresets1Label: string = "bow bass";
    public static midboxBassPresets2Label: string = "FM punch bass";
    public static midboxBassPresets3Label: string = "corrupted sine bass";
    public static midboxBassPresets4Label: string = "harsh mechanical bass 1";
    public static midboxBassPresets5Label: string = "growling bass";
    public static midboxBassPresets6Label: string = "chorus bass";
    public static midboxBassPresets7Label: string = "smooth bass";
    public static midboxBassPresets8Label: string = "chipped triangle bass 1";
    public static midboxBassPresets9Label: string = "chipped triangle bass 2";
    public static midboxBassPresets10Label: string = "sawscape bass";
    public static midboxBassPresets11Label: string = "harsh mechanical bass 2";
    public static midboxSynthPresets1Label: string = "high pad";
    public static midboxSynthPresets2Label: string = "magical pulse";
    public static midboxSynthPresets3Label: string = "spectrum pad";
    public static midboxSynthPresets4Label: string = "saturn pad";
    public static midboxSynthPresets5Label: string = "build-up pad";
    public static midboxSynthPresets6Label: string = "hyper saw synth";
    public static midboxSynthPresets7Label: string = "ambient pad";
    public static midboxSynthPresets8Label: string = "electronic rounded synth";
    public static midboxSynthPresets9Label: string = "punch synth";
    public static midboxSynthPresets10Label: string = "pulse synth";
    public static midboxSynthPresets11Label: string = "supersaw brass";
    public static midboxSynthPresets12Label: string = "supersaw click";
    public static midboxSynthPresets13Label: string = "space pad";
    public static midboxSynthPresets14Label: string = "hypersaw synth";
    public static midboxSynthPresets15Label: string = "spectrum strings";
    public static midboxSynthPresets16Label: string = "shifter synth";
    public static midboxSynthPresets17Label: string = "techno strings";
    public static midboxSynthPresets18Label: string = "bowed bell";
    public static midboxSynthPresets19Label: string = "future lead";
