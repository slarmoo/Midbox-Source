...
export class Localization {
    ...
    public static midboxMiscPresets55Label: string = "sawscape bass";
    public static midboxMiscPresets56Label: string = "spectrum strings";
    public static midboxMiscPresets57Label: string = "shifter synth";
    public static midboxMiscPresets58Label: string = "techno strings";
    public static midboxMiscPresets59Label: string = "dirty distortion guitar";
    public static midboxMiscPresets60Label: string = "midbox banjo 2";
    public static midboxMiscPresets61Label: string = "rave flute";
    public static midboxMiscPresets62Label: string = "phantom choir";
    public static midboxMiscPresets63Label: string = "FM wubber";
    public static midboxMiscPresets64Label: string = "harsh mechanical bass 2";
    public static midboxMiscPresets65Label: string = "cicada buzz";
    public static midboxMiscPresets66Label: string = "bitcrushian guitar";
    public static midboxMiscPresets67Label: string = "bowed bell";
    public static midboxMiscPresets68Label: string = "intense sitar";
    public static midboxMiscPresets69Label: string = "telephone ring 2";
