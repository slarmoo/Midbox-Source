...
export class Localization {
    ...
    public static songCorruptedLabel: string = "It appears that the song data has been corrupted. Try to recover the last working version of the song from the \"Recover Recent Song...\" option in Midbox's \"File/Sharing\" menu, or undo the changes that corrupted the song using the undo/redo buttons on your browser.";
    ...
    public static noteRecordingPromptLargeText6Label: string = "Tip: Recorded notes often overlap such that one note ends after the next note already started. In Midbox, these notes get split into two notes which may sound different when re-played than they did when you were recording. To fix the sound, you can either manually clean up the notes in the pattern editor, or you could try enabling the \"transition type\" effect on the instrument and setting it to \"continue\".";
...
if (language == "spanish") {
    ...
    Localization.songCorruptedLabel = "Parece que los datos de la canción se han dañado. Intente recuperar la última versión funcional de la canción desde la opción \"Recuperar canción...\" en el menú \"Archivo/Compartir\" de Midbox, o deshaga los cambios que corrompieron la canción usando los botones de deshacer/rehacer en su navegador.";
    ...
    Localization.noteRecordingPromptLargeText6Label = "Consejo: Las notas grabadas a menudo se superponen de tal manera que una nota termina después de que la siguiente ya haya comenzado. En Midbox, estas notas se dividen en dos notas que pueden sonar diferentes cuando se reproducen que cuando se estaban grabando. Para arreglar el sonido, puedes limpiar manualmente las notas en el editor de patrones, o puedes intentar activar el efecto \"tipo de transición\" en el instrumento y configurarlo en \"continuar\".";
