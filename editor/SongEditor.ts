...
export class SongEditor {
    ...
    private readonly _strumSpeedSlider: Slider = new Slider(input({ style: "margin: 0;", type: "range", min: "0", max: "12", value: "0", step: "1" }), this._doc, (oldValue: number, newValue: number) => new ChangeStrumSpeed (this._doc, oldValue, newValue), false);
