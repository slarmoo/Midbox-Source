    ...
    constructor(public readonly canvas: HTMLCanvasElement, readonly scale: number = 1) {
        this._EventUpdateCanvas = function(directlinkL: Float32Array, directlinkR ?: Float32Array): void {
            if(directlinkR) {
                ...
                ctx.fillStyle = ColorConfig.getComputed("--oscilloscope-line-L"); // Usually the same as --primary-text.
                ...
                ctx.fillStyle = ColorConfig.getComputed("--oscilloscope-line-R"); // Usually the same as --text-selection.
